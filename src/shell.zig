...
const Process = struct {
    ...
    pub fn create(allocator: std.mem.Allocator, argv_: tp.message, stdin_behavior: tp.subprocess.StdIo, handlers: Handlers) Error!tp.pid {
        ...
        self.* = .{
            .allocator = allocator,
            .argv = argv,
            .arg0 = try allocator.dupeSentinel(u8, arg0, 0),
    ...
    fn start(self: *Process) tp.result {
        ...
        self.sp = tp.subprocess.init(root.get_io(), self.allocator, self.argv, module_name, self.stdin_behavior) catch |e| return tp.exit_error(e, @errorReturnTrace());
