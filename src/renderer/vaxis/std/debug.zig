...
pub const SelfInfo = std.debug.SelfInfo;
pub const Info = std.debug.Info;
pub const Coverage = std.debug.Coverage;

pub const simple_panic = std.debug.simple_panic;
pub const no_panic = std.debug.no_panic;
...
pub const SourceLocation = std.debug.SourceLocation;

pub const Symbol = std.debug.Symbol;
